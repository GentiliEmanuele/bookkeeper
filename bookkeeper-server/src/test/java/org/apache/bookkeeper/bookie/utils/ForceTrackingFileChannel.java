...
/**
 * Spy channel that delegate all the ops to the real file channel
 */
public class ForceTrackingFileChannel extends FileChannel {
    private final FileChannel delegate;
    @Getter
    private boolean forceInvoked = false;
    @Getter
    private Boolean lastForceMetadataValue = null;

    public ForceTrackingFileChannel(FileChannel delegate) {
        this.delegate = delegate;
    }

    @Override
    public void force(boolean metaData) throws IOException {
        this.forceInvoked = true;
        this.lastForceMetadataValue = metaData;
